...
OBC_returnStateTypedef mass_storage_app(struct tc_tm_pkt *pkt);

OBC_returnStateTypedef mass_storage_mode_api(uint8_t sid, uint8_t mode);

OBC_returnStateTypedef mass_storage_delete_api(uint8_t sid, uint8_t mode, uint32_t to);

OBC_returnStateTypedef mass_storage_report_api(uint8_t sid,uint8_t *buf);

OBC_returnStateTypedef mass_storage_downlink_api(uint8_t sid,uint8_t *buf, uint16_t *size, , uint16_t *part);

OBC_returnStateTypedef mass_storage_store_api(uint8_t sid,uint8_t *buf);
